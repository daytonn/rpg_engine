defmodule D20.FifthEdition.Character do
  ...
  def strength_modifier(character), do: ability_modifier(character.base_strength)
  def dexterity_modifier(character), do: ability_modifier(character.base_dexterity)
  def constitution_modifier(character), do: ability_modifier(character.base_constitution)
  def intelligence_modifier(character), do: ability_modifier(character.base_intelligence)
  def wisdom_modifier(character), do: ability_modifier(character.base_wisdom)
  def charisma_modifier(character), do: ability_modifier(character.base_charisma)
  def ability_modifier(ability), do: ability - 10 |> div(2)
